...
def operations_mongodb():
    ...
    return {
        ...
        'sorted_students_asc_first': str(sorted_students_asc[0] if sorted_students_asc else {}),
        'sorted_students_desc_first': str(sorted_students_desc if sorted_students_desc else {}),
    }
